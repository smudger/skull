...
<template>
  <RadioGroup
    class="fixed bottom-0 inset-x-0 flex items-center justify-center bg-gray-50 p-2"
    name="estimate"
      ...
      >
        <div
          :class="[
            ...
            'flex items-center justify-center rounded-md shrink-0 text-lg sm:text-xl w-16 h-24 my-2 font-semibold uppercase',
          ]"
        >
